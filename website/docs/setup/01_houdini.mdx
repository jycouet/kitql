...
<br />
```js /* file: houdini.config.js */

/** @type {import('houdini').ConfigFile} \*/
const config = {
schemaPath: 'src/**/_.graphql',
sourceGlob: 'src/\*\*/_.{svelte,gql}',
scalars: {
...
<br />
```svelte /* file: src/routes/__layout.svelte */

<script context="module" lang="ts">
  import {houdiniClient} from '$graphql/client'; houdiniClient.init();
</script>
