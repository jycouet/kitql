...
<br />
<br />- If you were already using the server side, follow the config [here](/docs/setup/02_server#code-generator).
...
Then, the best is to directly check [Houdini's Doc](https://www.houdinigraphql.com/guides/working-with-graphql).
