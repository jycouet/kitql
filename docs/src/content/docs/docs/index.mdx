...
- For everywhere
  ...
  - ⚡️ [@kitql/helpers](/docs/tools/helpers) - 0️⃣ dep, 🪶 lightweight helpers for `logs`,
    `sleep`, `JSON`, ...
...
- For vite
  - 👀 [vite-plugin-watch-and-run](/docs/tools/vite-plugin-watch-and-run) - Adding watch mode to
    any command / Tool!
  - 🥶 [vite-plugin-stripper](/docs/tools/vite-plugin-stripper) - Remove some code on browser
    build.
...
You will find here list of potential interesting
videos.
