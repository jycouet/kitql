...
// getting @kitql/helper version (should be generated by the build script)
const pkgHelper = JSON.parse(
  fs.readFileSync(path.join(packageDirPath, '../helper', 'package.json'), 'utf-8'),
)
if (pkg?.dependencies?.['@kitql/helper']) {
