...
it('yop', () => {
  ...
  expect(message).toMatchInlineSnapshot(`
    "with all options: 
        $$KitQL_reset$$KitQL_reset$$KitQL_END$$
        $$KitQL_bold$$KitQL_bold$$KitQL_END$$
        $$KitQL_dim$$KitQL_dim$$KitQL_END$$
        $$KitQL_italic$$KitQL_italic$$KitQL_END$$
        $$KitQL_underline$$KitQL_underline$$KitQL_END$$
        $$KitQL_inverse$$KitQL_inverse$$KitQL_END$$
        $$KitQL_hidden$$KitQL_hidden$$KitQL_END$$
        $$KitQL_strikethrough$$KitQL_strikethrough$$KitQL_END$$
        $$KitQL_black$$KitQL_black$$KitQL_END$$
        $$KitQL_red$$KitQL_red$$KitQL_END$$
        $$KitQL_green$$KitQL_green$$KitQL_END$$
        $$KitQL_yellow$$KitQL_yellow$$KitQL_END$$
        $$KitQL_blue$$KitQL_blue$$KitQL_END$$
        $$KitQL_magenta$$KitQL_magenta$$KitQL_END$$
        $$KitQL_cyan$$KitQL_cyan$$KitQL_END$$
        $$KitQL_white$$KitQL_white$$KitQL_END$$
        $$KitQL_gray$$KitQL_gray$$KitQL_END$$
        $$KitQL_bgBlack$$KitQL_bgBlack$$KitQL_END$$
        $$KitQL_bgRed$$KitQL_bgRed$$KitQL_END$$
        $$KitQL_bgGreen$$KitQL_bgGreen$$KitQL_END$$
        $$KitQL_bgYellow$$KitQL_bgYellow$$KitQL_END$$
        $$KitQL_bgBlue$$KitQL_bgBlue$$KitQL_END$$
        $$KitQL_bgMagenta$$KitQL_bgMagenta$$KitQL_END$$
        $$KitQL_bgCyan$$KitQL_bgCyan$$KitQL_END$$
        $$KitQL_bgWhite$$KitQL_bgWhite$$KitQL_END$$
        $$KitQL_blackBright$$KitQL_blackBright$$KitQL_END$$
        $$KitQL_redBright$$KitQL_redBright$$KitQL_END$$
        $$KitQL_greenBright$$KitQL_greenBright$$KitQL_END$$
        $$KitQL_yellowBright$$KitQL_yellowBright$$KitQL_END$$
        $$KitQL_blueBright$$KitQL_blueBright$$KitQL_END$$
        $$KitQL_magentaBright$$KitQL_magentaBright$$KitQL_END$$
        $$KitQL_cyanBright$$KitQL_cyanBright$$KitQL_END$$
        $$KitQL_whiteBright$$KitQL_whiteBright$$KitQL_END$$
        $$KitQL_bgBlackBright$$KitQL_bgBlackBright$$KitQL_END$$
        $$KitQL_bgRedBright$$KitQL_bgRedBright$$KitQL_END$$
        $$KitQL_bgGreenBright$$KitQL_bgGreenBright$$KitQL_END$$
        $$KitQL_bgYellowBright$$KitQL_bgYellowBright$$KitQL_END$$
        $$KitQL_bgBlueBright$$KitQL_bgBlueBright$$KitQL_END$$
        $$KitQL_bgMagentaBright$$KitQL_bgMagentaBright$$KitQL_END$$
        $$KitQL_bgCyanBright$$KitQL_bgCyanBright$$KitQL_END$$
        $$KitQL_bgWhiteBright$$KitQL_bgWhiteBright$$KitQL_END$$
    "
  `)
