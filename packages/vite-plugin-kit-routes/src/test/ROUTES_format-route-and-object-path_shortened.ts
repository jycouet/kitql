...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'default /contract/[id]': 'lang' | 'id', 'create /site': 'lang', 'undefined /site': 'lang', 'update /site/[id]': 'lang' | 'id', 'delete /site/[id]': 'lang' | 'id', 'noSatisfies /site_contract': 'lang', 'send /site_contract/[siteId]-[contractId]': 'siteId' | 'contractId' | 'lang' }
