...
const ACTIONS = {
  ...
  'send site_contract_siteId_contractId': (params: {
    siteId: string | number
    contractId: string | number
    lang?: 'fr' | 'en' | 'hu' | 'at' | string
    extra?: 'A' | 'B'
...
export type KIT_ROUTES = {
  ...
  SERVERS: {
    ...
    'GET server_func_get_and': never
    'POST server_func_post': never
    'GET contract': 'lang'
    'POST contract': 'lang'
    'GET site': 'lang'
    'GET api_graphql': never
    'POST api_graphql': never
    'GET data_errors_locale_json': 'locale'
  }
  ACTIONS: {
    'default contract_id': 'lang' | 'id'
    'create site': 'lang'
    'u-p-d-a-t-e site': 'lang'
    'update site_id': 'lang' | 'id'
    'delete site_id': 'lang' | 'id'
    'noSatisfies site_contract': 'lang'
    'send site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang'
  }
