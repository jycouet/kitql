...
const PAGES = {
  ...
  "anchors": `/anchors`,
  "anchors_id": (id: (string | number), params?: {  }) => {
    return `/anchors/${id}`
  },
...
const ACTIONS = {
  ...
  "undefined site": (params?: { lang?: ('fr' | 'en' | 'hu' | 'at' | string) }) => {
...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'default contract_id': 'lang' | 'id', 'create site': 'lang', 'undefined site': 'lang', 'update site_id': 'lang' | 'id', 'delete site_id': 'lang' | 'id', 'noSatisfies site_contract': 'lang', 'send site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang' }
