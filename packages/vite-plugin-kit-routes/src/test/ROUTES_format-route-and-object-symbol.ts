...
export const PAGES = {
  ...
  "anchors": `/anchors`,
  "anchors_id": (params: { id: (string | number) }) => {
...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'default contract_id': 'id' | 'lang', 'create site': 'lang', 'undefined site': 'lang', 'update site_id': 'id' | 'lang', 'delete site_id': 'id' | 'lang', 'noSatisfies site_contract': 'lang', 'send site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang' }
