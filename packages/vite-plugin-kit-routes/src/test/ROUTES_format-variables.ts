...
export const PAGE_anchors = `/anchors`
export const PAGE_anchors_id = (params: { id: (string | number) }) => {
...
export const ACTION_undefined_site = (params?: { lang?: ('fr' | 'en' | 'hu' | 'at' | string) }) => {
...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'default_contract_id': 'id' | 'lang', 'create_site': 'lang', 'undefined_site': 'lang', 'update_site_id': 'id' | 'lang', 'delete_site_id': 'id' | 'lang', 'noSatisfies_site_contract': 'lang', 'send_site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang' }
