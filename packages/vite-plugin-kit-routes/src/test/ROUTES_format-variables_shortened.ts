...
export const PAGE_site_id = (params?: {
...
export const PAGE_site_contract_siteId_contractId = (params: {
...
export const PAGE_anchors_id = (params: {
  id: string | number
  hash: 'section0' | 'section1' | 'section2' | 'section3'
}) => {
 ...
 * ACTIONS
 */
export const ACTION_default_contract_id = (
  id: string | number,
  params?: { lang?: 'fr' | 'en' | 'hu' | 'at' | string; limit?: number },
) => {
...
export const ACTION_update_site_id = (
  id: string | number,
  params?: { lang?: 'fr' | 'en' | 'hu' | 'at' | string },
) => {
  return `${params?.['lang'] ? `/${params?.['lang']}` : ''}/site/${id}?/update`
}
export const ACTION_delete_site_id = (
  id: string | number,
  params?: { lang?: 'fr' | 'en' | 'hu' | 'at' | string },
) => {
  return `${params?.['lang'] ? `/${params?.['lang']}` : ''}/site/${id}?/delete`
}
export const ACTION_noSatisfies_site_contract = (params?: {
  lang?: 'fr' | 'en' | 'hu' | 'at' | string
}) => {
  return `${params?.['lang'] ? `/${params?.['lang']}` : ''}/site_contract?/noSatisfies`
}
export const ACTION_send_site_contract_siteId_contractId = (params: {
  siteId: string | number
  contractId: string | number
  lang?: 'fr' | 'en' | 'hu' | 'at' | string
  extra?: 'A' | 'B'
...
export const LINK_gravatar = (
  str: string | number,
  params?: { s?: number; d?: 'retro' | 'identicon' },
) => {
  params = params ?? {}
...
type ExtractParamType<T extends (param: any) => any> = ExtractFnPredicate<T> extends never
  ? Parameters<T>[0]
...
export type KIT_ROUTES = {
  ...
  SERVERS: {
    GET_server_func_get: never
    GET_server_func_get_and: never
    POST_server_func_post: never
    GET_contract: 'lang'
    POST_contract: 'lang'
    GET_site: 'lang'
    GET_api_graphql: never
    POST_api_graphql: never
    GET_data_errors_locale_json: 'locale'
  }
  ACTIONS: {
    default_contract_id: 'lang' | 'id'
    create_site: 'lang'
    'u-p-d-a-t-e_site': 'lang'
    update_site_id: 'lang' | 'id'
    delete_site_id: 'lang' | 'id'
