...
export const PAGE_anchors_id = (id: (string | number), params?: {  }) => {
  return `/anchors/${id}`
}
...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'default_contract_id': 'lang' | 'id', 'create_site': 'lang', 'undefined_site': 'lang', 'update_site_id': 'lang' | 'id', 'delete_site_id': 'lang' | 'id', 'noSatisfies_site_contract': 'lang', 'send_site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang' }
