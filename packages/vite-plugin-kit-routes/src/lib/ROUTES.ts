...
const PAGES = {
  ...
  "/anchors": (params: { hash: ("section0" | "section1" | "section2" | "section3"), anotherOne?: (string) }) => {
...
const LINKS = {
  ...
  "default_values_site": (params: { sBooleanRequired: (boolean), sArrayRequired: (Array<boolean | string | number | null>), bool?: (boolean), arr?: (Array<boolean | string | number | null>), sNumber?: (number), sBoolean?: (boolean), sArray?: (Array<boolean | string | number | null>) }) => {
...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/base': 'all', '/subGroup': never, '/subGroup/user': never, '/subGroup2': never, '/contract': 'lang', '/contract/[id]': 'id' | 'lang', '/gp/one': 'lang', '/gp/two': 'lang', '/main': 'lang', '/match/[id=ab]': 'id' | 'lang', '/match/[id=int]': 'id' | 'lang', '/site': 'lang', '/site/[id]': 'lang' | 'id', '/site_contract/[siteId]-[contractId]': 'siteId' | 'contractId' | 'lang', '/[u+d83e][u+dd2a]': never, '/[u+d83e][u+dd2a]/[emoji]/[u+2b50]': 'emoji', '/[x+2e]well-known': never, '/a/[...rest]/z': 'rest', '/anchors': never, '/anchors/[id]': 'id', '/lay/normal': never, '/lay/root-layout': never, '/lay/skip': never, '/md': never, '/mdsvex': never, '/sp': never, '/spArray': never, '/spArrayComma': never }
  SERVERS: Record<string, never>
  ACTIONS: Record<string, never>
  LINKS: { 'bluesky': never, 'bluesky_post': 'did' | 'post_id', 'gravatar': 'str', 'default_values_site': 'bool' | 'arr' }
  Params: { 'all': never, 'first': never, 'lang': never, 'id': never, 'limit': never, 'demo': never, 'da-sh': never, 'siteId': never, 'contractId': never, 'emoji': never, 'rest': never, 'hash': never, 'anotherOne': never, 'ids': never, 'did': never, 'post_id': never, 'str': never, 's': never, 'd': never, 'sBooleanRequired': never, 'sArrayRequired': never, 'bool': never, 'arr': never, 'sNumber': never, 'sBoolean': never, 'sArray': never }
}
