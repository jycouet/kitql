...
export const ACTIONS = {
  ...
  "sendSomething_lang_site_contract_siteId_contractId": (params: { siteId: (string | number), contractId: (string | number), lang?: ('fr' | 'en' | 'hu' | 'at' | string) }) => {
...
export type KIT_ROUTES = { 
  ...
  ACTIONS: { 'lang_contract_id': 'id' | 'lang', 'action1_lang_site': 'lang', 'action2_lang_site': 'lang', 'noSatisfies_lang_site_contract': 'lang', 'sendSomething_lang_site_contract_siteId_contractId': 'siteId' | 'contractId' | 'lang' }
