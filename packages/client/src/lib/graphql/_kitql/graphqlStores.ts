...
function KQL_AllContinentsStore() {
	...
	// prettier-ignore
	const { subscribe, set, update } = writable<RequestResult<Types.AllContinentsQuery, Types.AllContinentsQueryVariables>>({...defaultStoreValue, operationName, operationType});
...
function KQL_AllCountriesOfContinentStore() {
	...
	// prettier-ignore
	const { subscribe, set, update } = writable<RequestResult<Types.AllCountriesOfContinentQuery, Types.AllCountriesOfContinentQueryVariables>>({...defaultStoreValue, operationName, operationType});
